...
This project is supposed to help you learn. _**Do not use any AI to complete it for you**_. The challenges in this project are easily solved using AI. If you do not know something, ask a question or spend some time browsing documentation and online guides rather than sliding your faviourite AI a DM.
